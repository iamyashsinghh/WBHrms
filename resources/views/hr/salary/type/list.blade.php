    ...
    <script>
        $(document).ready(function() {
            const salaryTypeTable = $('#salaryTypeTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('hr.salary-type.ajax_list') }}",
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'name', name: 'name' },
            ...
            window.handleManageSalaryType = function(id, name, value, category) {
                ...
                const url = id
                    ? `{{ route('hr.salary-type.manage_process', ':id') }}`.replace(':id', id)
                    : "{{ route('hr.salary-type.manage_process') }}";
            ...
            window.handleDeleteSalaryType = function(id) {
                ...
                const url = `{{ route('hr.salary-type.destroy', ':id') }}`.replace(':id', id);
