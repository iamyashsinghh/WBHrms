...
<script>
    ...
    html: `
        <div style="position: relative; width: 40px; height: 60px;">
            ...
            ${isOnline ? `
            <div style="position: absolute; top: 50px; left: 50%; transform: translateX(-50%); width: 10px; height: 10px; background: rgba(0, 255, 0, 0.5); border-radius: 50%; animation: pulse 1.5s infinite;"></div>
            ` : ''}
        </div>
        <style>
            @keyframes pulse {
