                ...
                <table id="clientTable" class="table text-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.role.update.isAllTimeLogin')}}/{{$role->id}}/{{$role->is_all_time_login == 1 ? 0 : 1}}"
...
<script>
    $(document).ready(function () {
        ...
        $('.puch-time').on('change', function () {
            ...
            $.ajax({
                url: `{{ route('admin.role.updatePunchTime') }}`,
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    role_id: roleId,
        ...
        $('.grace_time').on('change', function () {
            ...
            $.ajax({
                url: `{{ route('admin.role.updateGraceTime') }}`,
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    role_id: roleId,
        ...
        $('.lating_time').on('change', function () {
            ...
            $.ajax({
                url: `{{ route('admin.role.updateLatingTime') }}`,
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    role_id: roleId,
