...
class DashboardController extends Controller
{
    public function index(){
        ...
        return view('admin.dashboard', compact('total_users', 'month', 'year', 'preDayAttendance', 'preDayAttendancePresent', 'preDayAttendanceAbsent', 'preDayAttendanceHalfday','preDayAttendanceWo'));
    }
}
